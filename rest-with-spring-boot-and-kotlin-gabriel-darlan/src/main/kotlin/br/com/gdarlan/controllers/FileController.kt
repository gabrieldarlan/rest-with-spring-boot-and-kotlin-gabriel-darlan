...
import br.com.gdarlan.data.vo.v1.UploadFileResponseVO
import br.com.gdarlan.services.FileStorageService
...
class FileController {
    ...
    fun uploadFile(@RequestParam("file") file: MultipartFile): UploadFileResponseVO {
        ...
        val fileDowloadUri = ServletUriComponentsBuilder.fromCurrentContextPath()
            .path("/api/file/v1/uploadFile/")
            .path(fileName)
            .toUriString()
        return UploadFileResponseVO(fileName, fileDowloadUri, file.contentType!!, file.size)
    }
